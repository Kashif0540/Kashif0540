...
class Developer:
    def __init__(self):
        self.name       = "Muhammad Kashif"
        self.degree     = "BS Computer Science — University of Central Punjab, Lahore"
        self.focus      = ["Full Stack Web Dev", "AI/LLM Integration", "Automation"]
        self.stacks     = ["MERN", "Laravel"]
        self.languages  = ["JavaScript", "Python", "PHP", "C++", "SQL"]
        self.building   = "AI systems that handle real work — not just demos"
        self.open_to    = ["Internships", "Collaborations", "Freelance"]

    def say_hi(self):
        print("Thanks for stopping by — check out my repos below. 🚀")
...
```
🌐 MERN & Laravel             ████████████████  Done
🤖 LLM Integration & RAG      ██████████████░░  88%
⚙️ AI Agents & Automation      ██████████░░░░░░  62%
🏪 E-Commerce (Motor Accs.)    ████░░░░░░░░░░░░  25%
```
